...
¿Por qué es importante? Hace que tu código sea flexible. Si tu aplicación depende de una interfaz BaseDeDatos, puedes cambiar de MySQL a MongoDB sin cambiar ni una línea de tu lógica de negocio principal.
